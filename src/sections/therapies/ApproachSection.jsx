		...
		<section id="approach">
			...
			>
				...
				<p className="leading-relaxed max-w-4xl mx-auto text-gray-700">
					...
					.
					<br /> Grâce à une combinaison de techniques thérapeutiques adaptées,
					je vous accompagne pour surmonter vos blocages, retrouver confiance en
					vous et avancer vers un équilibre personnel et professionnel.
				</p>
				<Link href="/contact">
					<Button
						text="Me contacter"

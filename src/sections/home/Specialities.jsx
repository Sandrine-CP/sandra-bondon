		...
		<section className="py-16 px-4 text-center">
			...
			<div className="mt-20">
				...
				>
					...
					<svg
						class="w-8 h-8 justify-end group-hover:rotate-90 group-hover:bg-secondary text-secondary ease-linear duration-300 rounded-full border border-gray-700 group-hover:border-none p-2 rotate-45"
						viewBox="0 0 16 19"
